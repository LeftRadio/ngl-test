...
typedef enum { Clip_OFF = 0, Clip_ON = 1 }  NGL_ClipType;
...
typedef struct
{
	...
	const NGL_Bitmap *ICO;				    // Icon/bitmap
...
typedef struct
{
	...
	const pEvent Draw;
	void (*Click)(Coordinate data, NGL_TouchType type);			// Page click (or index change) function
} NGL_Page;
